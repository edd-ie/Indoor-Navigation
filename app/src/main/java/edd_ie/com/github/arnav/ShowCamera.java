...
public class ShowCamera extends AppCompatActivity
    ...
    private static final String TAG = ShowCamera.class.getSimpleName();
    ...
    private com.google.ar.core.SharedCamera sharedCamera;
    ...
    private static boolean arcoreActive;
    ...
    private static final SnackbarHelper messageSnackbarHelper = new SnackbarHelper();
    ...
    private final CameraDevice.StateCallback cameraDeviceCallback =
            new CameraDevice.StateCallback() {
                ...
                public void onOpened(@NonNull CameraDevice cameraDevice) {
                    ...
                    ShowCamera.this.cameraDevice = cameraDevice;
                ...
                public void onClosed(@NonNull CameraDevice cameraDevice) {
                    ...
                    ShowCamera.this.cameraDevice = null;
                    safeToExitApp.open();
                }
    ...
    CameraCaptureSession.StateCallback cameraSessionStateCallback =
            new CameraCaptureSession.StateCallback() {
                ...
                public void onActive(@NonNull CameraCaptureSession session) {
                    ...
                    synchronized (ShowCamera.this) {
                        captureSessionChangesPossible = true;
                        ShowCamera.this.notify();
                    }
